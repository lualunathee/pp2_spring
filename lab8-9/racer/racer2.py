...
# Load background
background = pygame.image.load("photo_2024-04-13_07-25-27.jpg")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("photo_2024-04-13_07-25-37.jpg")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("photo_2024-04-13_07-25-41.jpg")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):  
    def __init__(self, weight=1):
        ...
        if self.weight == 1:
            image_path = "photo_2024-04-13_07-25-44.jpg"  # Path for the first coin image
            
        else:
            image_path = "photo_2024-04-13_07-25-48.jpg"  # Path for the second coin image
